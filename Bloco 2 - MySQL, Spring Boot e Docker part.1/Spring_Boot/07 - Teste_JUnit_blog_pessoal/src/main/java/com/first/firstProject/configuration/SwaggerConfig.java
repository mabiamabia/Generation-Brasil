package com.first.firstProject.configuration;
...
public class SwaggerConfig {
	...
	public static ApiInfo metadata() {
		return new ApiInfoBuilder().title("Blog Pessoal").description("API do Projeto de blog pessoal")
				.version("1.0.0").license("Apache License Version 2.0").licenseUrl("http://localhost:8080/swagger-ui/")//testar isso
				.contact(contact()).build();
	}

	private static Contact contact() {
		return new Contact("Mabia", "https://github.com/prisciladuarte", "duartecostap@gmail.com");
	}
